package com.example.hugtra.accesointernet2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String url = "http://ep00.epimg.net/rss/tags/ultimas_noticias.xml";
    ...
    public  class TareaHttpAsincrona extends AsyncTask<String, String, String> {
        ...
        private void comprobarConexionInternet(){
            ...
            if (conectivityManager != null) {
                ...
                Toast.makeText(MainActivity.this, "Fallo en conexion a Internet", Toast.LENGTH_SHORT).show();
        }
